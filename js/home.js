...
//
function isMobile() {
    if (/iPad/i.test(navigator.userAgent) && $(window).width() > 980) {
        return false;
    }
...
function onPlayerStateChange(event) {
    ...
    if (status == 0) {
        vidPause = true;
        console.log("video end: " + vidPause);
    } //VIDEO ENDED
    else if (status == 1) {
        vidPause = false;
        console.log("video play: " + vidPause);
    } //VIDEO IS PLAYING
    else if (status == 2) //VIDEO IS PAUSED
    {
        vidPause = true;
        console.log("video pause: " + vidPause);
    }
}
...
function pauseYTVideo() {
    ...
    setTimeout(function () {
        vidPause = false;
        console.log("video soft pause: " + vidPause);
    }, 100);
}
//-------------------------------------------------------------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------------------------------------------------------------
...
$(document).ready(function () {
    ...
    window.addEventListener("mousemove", function () {
        access = false; /*console.log("mousemove happened");*/
    }, true);
